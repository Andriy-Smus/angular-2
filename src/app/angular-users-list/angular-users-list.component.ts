...
@Component({
  selector: 'app-angular-users-list',
  templateUrl: './angular-users-list.component.html',
  styleUrls: ['./angular-users-list.component.scss']
})
export class AngularUsersListComponent {
